...
At this point, you should review the available codebooks for the data set that most interests you.  The [PDS](https://github.com/alanarnholt/PDS)^[https://github.com/alanarnholt/PDS] R package has the [codebooks](https://github.com/alanarnholt/PDS/tree/master/inst/CodeBooks) and data sets for this course.


**Selecting A Data Set Assignment**

Start thinking about a data set that you will work with.
In an upcoming assignment you'll be asked to select the data set and the
variables you wish to use along with research questions that connect the variables.

<!---
Select a data set that you will work with.
Add the abbreviated title of that data set (i.e., AddHealthW1, AddHealthW4, NESARC, Mars Crater, IPEDS, or OOL) to the README file of your GitHub repository.
-->
